...
############################################################################################
##
## Script to install the latest PPPC Utility
##
## VER 4.0.0
##
## Change Log
...
processpath="/Applications/Utilities/$app/Contents/MacOS/$appname" # The process name of the App we are installing
...
function updateOctory() {
    ...
    # Is Octory present
    if [[ -e "/Library/Application Support/Octory" ]]; then
